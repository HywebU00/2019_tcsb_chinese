...
$(document).ready(function () {
  ...
  $('.vertical-syncing').slick({
    ...
    responsive: [
      ...
      { breakpoint: 600, settings: { slidesToShow: 2, slidesToScroll: 2, vertical: false, verticalSwiping: false } },
      { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1, vertical: false, verticalSwiping: false } },
    ],
  });
  $('.mp_stuffSlider').slick({
    ...
    autoplaySpeed: 1500,
    responsive: [
      { breakpoint: 1024, settings: { slidesToShow: 5, slidesToScroll: 5, infinite: true, dots: false } },
      { breakpoint: 600, settings: { arrows: false, slidesToShow: 3, slidesToScroll: 3 } },
      { breakpoint: 480, settings: { arrows: false, slidesToShow: 2, slidesToScroll: 2 } },
    ],
  });
  $('.Responsive_slider').slick({
    dots: false,
  ...
  $('.website_slider').slick({
    ...
    responsive: [
      ...
      { breakpoint: 991, settings: { dots: false, arrows: false, slidesToShow: 3, slidesToScroll: 1 } },
      { breakpoint: 600, settings: { dots: false, arrows: false, slidesToShow: 2, slidesToScroll: 1 } },
...
$(window).scroll(function () {
  if ($(this).scrollTop() > 130) {
    $('.back_page').stop(true, false).fadeIn();
  } else {
    $('.back_page').stop(true, false).fadeOut();
  }
});
$(document).ready(function () {
...
$(function () {
  $('.Single_slider').slick({ dots: true, dotsClass: 'slick-dots', infinite: true, autoplay: true, autoplaySpeed: 5000, slidesToShow: 1, fade: true, slidesToScroll: 1 });
});
$(function () {
  $('.servicebanner').slick({ dots: false, dotsClass: 'slick-dots', infinite: true, autoplay: true, autoplaySpeed: 5000, slidesToShow: 1, fade: true, slidesToScroll: 1 });
});
$(document).ready(function () {
...
$(function () {
  ...
  $(document).click(function (e) {
    var target = e.target;
    if (!$(target).is('.community_rights ul>li>a')) {
      $('.community_rights ul ul').hide();
    }
  });
  $('.community_rights ul li ul li:last-child a').focusout(function () {
    $('.community_rights ul ul').slideUp(200);
  });
});
$(function () {
  $('#fast').click(function () {
...
$(function () {
  $('.group01').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.news').offset().top }, 1200, 'easeOutExpo');
    $('.news').find('.firstlink').focus();
  });
  $('.group02').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.importantdata_block').offset().top }, 1200, 'easeOutExpo');
    $('.importantdata_block').find('.slick-prev').focus();
  });
  $('.group03').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.recommend_block').offset().top }, 1200, 'easeOutExpo');
    $('.recommend_block').find('.slick-prev').focus();
  });
  $('.group04').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.communityblock').offset().top }, 1200, 'easeOutExpo');
    $('.communityblock').find('.firstlink').focus();
  });
  $('.group05').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.education_block').offset().top }, 1200, 'easeOutExpo');
    $('.education_block').find('.firstlink').focus();
  });
  $('.group06').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.industry').offset().top }, 1200, 'easeOutExpo');
    $('.industry').find('.firstlink').focus();
  });
  $('.group07').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.propagandamovie').offset().top }, 1200, 'easeOutExpo');
    $('.propagandamovie').find('.firstlink').focus();
  });
  $('.group08').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.activityphoto').offset().top }, 1200, 'easeOutExpo');
    $('.activityphoto').find('.slick-prev').focus();
  });
  $('.group09').click(function () {
    $('body,html')
      .stop(true, true)
      .animate({ scrollTop: $('.common_links').offset().top }, 1200, 'easeOutExpo');
